...
module.exports =async(callback) =>{
    try{
     ...
     transfer(faucetContract.address,web3.utils.toWei('10','Ether'))
     .send({from:daiHolder});
    
     balance = await daiContract.methods.balanceOf(faucetContract.address).call();
     console.log("faucetContract.address balance",balance)
         ...
         console.log("recipient holder balance",balance)
